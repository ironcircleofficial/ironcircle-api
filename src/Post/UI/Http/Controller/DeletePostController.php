...
final class DeletePostController extends AbstractController
{
    ...
    #[Route('/api/v1/posts/{id}', name: 'posts_delete', methods: ['DELETE'])]
    ...
    public function delete(string $id): JsonResponse
    {
        try {
            ...
            if (!$this->isGranted(PostVoter::DELETE, $post)) {
                return new JsonResponse(
                    ['error' => 'FORBIDDEN', 'message' => 'You do not have permission to delete this post'],
            ...
            return new JsonResponse(
                ['error' => 'DELETE_FAILED', 'message' => 'An error occurred during post deletion'],
