...
use App\Circle\UI\Http\Request\ChangeCircleVisibilityRequest;
...
final class ChangeCircleVisibilityController extends AbstractController
{
    ...
    #[Route('/{id}/visibility', name: 'change_visibility', methods: ['PATCH'])]
    #[IsGranted('IS_AUTHENTICATED_FULLY')]
    public function changeVisibility(
        string $id,
        #[MapRequestPayload] ChangeCircleVisibilityRequest $request
    ): JsonResponse {
        try {
            $user = $this->getUser();
            ...
            $command = new ChangeCircleVisibilityCommand(
                circleId: $id,
            ...
            if (!$handledStamp instanceof HandledStamp) {
                return new JsonResponse(
                    ['error' => 'UPDATE_FAILED', 'message' => 'Visibility update failed'],
            ...
            return new JsonResponse(
                ['error' => 'UPDATE_FAILED', 'message' => 'An error occurred during visibility update'],
                Response::HTTP_INTERNAL_SERVER_ERROR
            );
        } catch (\Exception $e) {
            return new JsonResponse(
